...
const ChatTab = () => {
  ...
  return (
    <div className="<div className="grid grid-cols-1 md:grid-cols-[minmax(300px,380px)_1fr] gap-4 h-[calc(100vh-120px)] min-w-0 min-h-0"> gap-4 h-[calc(100vh-120px)] min-w-0 min-h-0">
